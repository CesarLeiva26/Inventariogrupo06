$(document).on("click", "#btnagregar", function(){
	...
	$.ajax({
		type: "GET",
		url: "/DetalleConteo/listarDetalleConteo",
		dataType: "json",
...
$(document).on("click", ".btnactualizar", function(){
	...
	$("#modalDetalleConteo").modal("show");
});

$(document).on("click", "#btnguardar", function(){
	$.ajax({
		type: "POST",
		url: "/DetalleConteo/registrarDetalleConteo",
...
$(document).on("click", "#btneliminar", function(){
	$.ajax({
		type: "DELETE",
		contentType: 'application/json',
		url: "/DetalleConteo/eliminarDetalleConteo",
		data: JSON.stringify({
	...
	$("#modalEliminarDetalleConteo").modal("hide");
})
